...
if __name__ == "__main__":
    ...
    plt.ylabel('count')
    plt.savefig('./graph/new_graph/matching_random_' + str(numsection) + 'section_' + str(second) + 'second_supply_minus_demand.png')
    ...
    plt.xlabel('episode')
    plt.ylabel('score')
    plt.savefig('./graph/new_graph/matching_random_' + str(numsection) + 'section_' + str(second) + 'second_score.png')
